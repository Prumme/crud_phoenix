defmodule AurelWeb.ContactControllerTest do
  use AurelWeb.ConnCase

  alias Aurel.DB

  @create_attrs %{email: "some email", firstname: "some firstname", pers: true, pro: true, uuid: "some uuid"}
  ...
  def fixture(:contact) do
    {:ok, contact} = DB.create_contact(@create_attrs)
    contact
  end
